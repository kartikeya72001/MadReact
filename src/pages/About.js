    ...
    render(){
        return(
            <div>
                ...
                <Container style={{position:"relative",top:"14rem",width:"90%"}}>
                <Row>
                    <Col sm={7} style={{position:"relative",top:"3rem",marginBottom:"15rem"}}><img src="/images/AboutBackground.png"/></Col>
                    <Col sm={5}>
                        <h1 className="heading">About Music Art Dance</h1>
                        <p className="text">
